...
namespace Glücksrad_Project
{
    ...
    public partial class Category : Form
    {
        ...
        {
            int zufall;
            //Sucht eine zufallszahl der länge des arrays
            do
        ...
        {
            //Erstellt eine Liste zu allen Kategoriene
            ...
            //erstellt lokale kopie des ausgewählten arrays
            string[] categoryLocal = null;
            if (Temp is string[])
                categoryLocal = (string[])Temp;
            int zufall;
            //sucht zufällig einen Begriff heraus
            do
            {
                zufall = random.Next(0, 100);
